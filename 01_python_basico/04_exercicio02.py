...
o tempo gasto na viagem e a velocidade média durante ela.
Desta forma, será possível obter a distância percorrida 
com a fórmula DISTANCIA = TEMPO * VELOCIDADE. 
Tendo o valor da distância, basta calcular a quantidade 
de litros de combustível utilizada na viagem, com a 
fórmula: LITROS_USADOS = DISTANCIA / 12. 
O programa deve apresentar os valores da velocidade média,
tempo gasto na viagem, a distância percorrida e a 
quantidade de litros utilizada na viagem
"""

tempo_gasto = int(input('Tempo gasto da viagem\n'))
tempo_gasto_horas = tempo_gasto / 60
velocidade_media = int(input('Velocidade média da viagem\n'))
distancia = (tempo_gasto_horas * velocidade_media)
